<div class="box box2" id="listOS">
	<div class="box_topo amarelo"><span> Histórico de ordens de serviço</span></div>
	...
	<?php foreach ($lista as $equip) {?>
		...
		<div class="listar">
			...
			<form action="php/veros.php" method="post" class="formos" >
				...
				<input type="submit" class="bdamarelo <?= $classe ?>" value="<?= $equip['tipo']." ".$equip['marca']." ".$equip['ram']." ".$equip['hd']  ?>" />
