...
<div class="box box3" id="listCH">
	<div class="box_topo amarelo"><span>Lista de chamados encerrados</span></div>
				...
				<td>
					...
					<td><div class="listar">
						<form action="php/verch.php"  method="post" class="formCH">
							...
							<input type="submit" class="bdamarelo "  value="<?= date('d/m/Y', strtotime($user->data_horainicio)); ?>"/></form>
						</div>
