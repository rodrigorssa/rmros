...
$dados=R::getRow("SELECT * FROM equipamentos e LEFT OUTER JOIN users u ON e.id_cliente=u.id JOIN compusers c ON c.id=u.id  AND u.id=$id_cliente AND e.id=$id"); 
