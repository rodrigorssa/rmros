...
<div class="box box4">
	...
	<?php // PARA NOVO EQUIPAMENTO 
      ...
      //PARA LISTAR EQUIPAMENTOS
		 ...
		 <a href="equipamentos.php?idCl=<?= $id  ?>" class="btn azul btn-pdd" >NOVO EQUIPAMENTO</a>


		 <?php die();  } ?>
		<div class="box_topo azul"><span>Lista de equipamentos</span></div>
		 	...
		 	<div class="listar">
		 		...
		 		<form action="equipamentos.php" method="post" >
		 			<input type="hidden" value="<?= $equip['id'] ?>" name="id" />
		 				<input type="submit" class="bdazul" value="<?= $equip['tipo']." ".$equip['marca']." ".$equip['ram']." ".$equip['hd']  ?>" />
