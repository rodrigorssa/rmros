...
<div class="box_topo azul"><span>Ordem de serviço n° <?= $os->id ?></span></div>
<form id="pos" action="<?= $action ?>" class="form_index" style="position:relative" data-redirect="<?= $redirect ?>">
		...
		<?php } //END ELSE ?>
			...
			<input type="submit"  class="btn btn_large azul" id="enc_os" name="enc_os" value="Salvar e encerrar OS" />
