...
<form action="<?= $action2.$a ?>" method="post" id="cdform" class="form_index hide" id="formcad" data-redirect="<?= $direct2 ?>" >
		...
		<input type="text" id="cduser" name="endereco" placeholder="Endereço." value="<?php if($retorno!=array()) echo $retorno->endereco; ?>" maxlength="100" required/>

		<label for="cdpass">Numero:</label>
		<input type="text" id="cdpass" name="numero" placeholder="Numero." value="<?php if($retorno!=array()) echo $retorno->numero; ?>"value="<?php if($retorno!=array()) echo $retorno->endereco; ?>" required/>

		<label for="cdbairro">Bairro:</label>
		<input type="text" id="cdbairro" name="bairro" placeholder="Bairro."value="<?php if($retorno!=array()) echo $retorno->bairro; ?>"  required/>
